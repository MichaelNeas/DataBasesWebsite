<?php 
    ...
    <?php 
        $query = "SELECT PersonID,FirstName,LastName FROM `customer` INNER JOIN `person` ON customer.CustomerId=`person`.`PersonID` ORDER BY person.LastName ASC";
...
?>	
	<div id="peopleButtons">
      <button type="modbutton">Send to Modify Customer's Information</button>
      <button type="modbutton">Contact Customer</button>
      <button type="modbutton">Customer Order List</button>
    </div> 
